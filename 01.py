...
# inventory of their supplies.  One important consideration is food -
# in particular, the number of Calories each Elf is carrying (your
# puzzle input).
#
...
sums = [
    sum(int(v) for v in elf_list.split())
    for elf_list in open("01.in").read().split("\n\n")
]
print(max(sums))
